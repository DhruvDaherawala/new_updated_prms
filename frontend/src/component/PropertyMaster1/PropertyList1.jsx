...
//   const [currentPage, setCurrentPage] = useState(1);
//   const [searchTerm, setSearchTerm] = useState('');
//   const [propertyList, setPropertyList] = useState(properties); // Local state to manage properties

//   // Sync local state with props when properties change
//   useEffect(() => {
...
//       case 'pending':
//         return 'warning';
//       case 'deleted': // Optional: Handle 'Deleted' status if it ever shows up
//         return 'error';
//       default:
//         return 'primary';
//     }
...
//       if (response.ok) {
//         // Remove the property from the local state instead of relying on parent
//         setPropertyList((prevList) => prevList.filter((p) => p.id !== property.id));
//         console.log(`Property ${property.id} marked as deleted`);
//       } else {
//         console.error('Failed to mark property as deleted:', response.statusText);
//       }
//     } catch (error) {
...
//                         Edit
//                       </button>
//                       <button className="bg-red-100 text-red-600 px-3 py-1 rounded hover:bg-red-200" onClick={() => handleDelete(prop)}>
//                         Delete
//                       </button>
//                     </div>
//                   </td>
