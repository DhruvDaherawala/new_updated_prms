...
//         ownerName: localProperty.ownerName,
//         address: localProperty.address,
//         floors: localProperty.numberOfFloors || '',
...
//         headers: { 'Content-Type': 'multipart/form-data' }
//       });
//       console.log(localProperty.floors);
//       alert('Property updated successfully!');
//       refreshProperties();
//       setIsEditing(false);
//     } catch (error) {
...
export default function PropertyDetailModal({ property, onClose, refreshProperties, apiUrl }) {
  ...
  const saveProperty = async () => {
    try {
      ...
      console.log(localProperty.numberOfFloors);
      alert('Property updated successfully!');
      refreshProperties();
      setIsEditing(false);
    } catch (error) {
          ...
          {isEditing ? (
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-2 gap-6">
                ...
                <div>
                  <h3 className="text-sm font-medium text-gray-500">Number of Floors</h3>
                  <p className="mt-1 text-lg">{localProperty.numberOfFloors || 'Not specified'}</p>
                </div>
              </div>
